...
void sumOfSumsColumns(const short array[][3],
                      short arraySum[],
                      const short numbercolumn, const short rows)
{
    for (short i = 0; i < rows; i++)
    {
        arraySum[i] = sumColumn(array, i, rows);
    }
}
int main()
{
    ...
    sumOfSumsColumns(array, arraySum, 3, 3);
