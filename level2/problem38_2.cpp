...
{
    short length;
    cout << "\n--Making A Randomn Array And Copy Odd--\n\n"
         << "Enter length: ";
    cin >> length;
...
void copyArrayByElementForOdd(const short array_b[], const short length,
                              short &length_c, short array_c[])
{
    for (short i = 0; i < length; i++)
    {
...
int main()
{
    ...
    copyArrayByElementForOdd(array_b, length, length_c, array_c);
    cout << "====================================\n"
         << "Array 2 Odd Number:\n";
