...
{
    short length;
    cout << "\n-Making A Random Array And count Average-\n\n"
         << "Enter length: ";
    cin >> length;
...
void printAverage(const short array[], const short length)
{
    cout << "========================================\n"
         << "Average Of All Numbers In Array = "
         << sumNumbersInArray(array, length) / float(length) << '\n';
}
int main()
{
