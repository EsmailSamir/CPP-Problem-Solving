...
{
    short length;
    cout << "\n-Making A Randomn Array And Count Positive Numbers-\n\n"
         << "Enter length: ";
    cin >> length;
...
short countPositiveNumbers(const short array[], const short length)
{
    short positive = 0;
    for (short i = 0; i < length; i++)
    {
...
void printResultCountPositive(const short array[], const short length)
{
    cout << "Positive Numbers count is: "
         << countPositiveNumbers(array, length) << '\n';
}
int main()
{
    ...
    cout << "\n=======================================\n";
    printResultCountPositive(array, length);
    return 0;
}